...
로그인 후
<div class="login-area ms-3 login-info" style="">
	...
	<div class="layer-my">
		<div class="user-info">
			<div class="account-info">
				<p class="email">
					<span class="icon-mylogin-google"><span class="blind">구글로 로그인</span></span>
					<span class="txt">kminchoi17@gmail.com</span>
				</p>
			</div>
			<div class="btns">
				<a href="https://member.hankyung.com/apps.frame/member.main?url=https%3A//www.hankyung.com/help/qna" class="btn-account">계정관리</a>
				<a role="button" class="btn-logout" href="https://member.hankyung.com/apps.frame/login.work.logout?url=https%3A//www.hankyung.com/help/qna">로그아웃</a>
			</div>
		</div>
