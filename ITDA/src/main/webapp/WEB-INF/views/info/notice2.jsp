...
<html lang="ko">
    <head>
        ...
        <link rel="stylesheet" href="https://static.hankyung.com/css/www/w/common.ui.all.css?v=202310131759">
        <link rel="stylesheet" href="https://static.hankyung.com/resource/www/help/css/help.css?v=202310131759">
		...
		<script type="text/javascript" src="https://static.hankyung.com/js/ga/googleTagManager.js?v=202310131759" async="true"></script>
    </head>
    <body>
...
$('.gnb-section:not(.type-hover) .gnb-dropdown-toggle, .gnb-dropdown.type-click .gnb-dropdown-toggle').on("click", function(e){
	...
	return false;
                    ...
                    <ul class="gnb-section">
                        ...
                        <li class="on"><a href="https://www.hankyung.com/help/qna" target="">1:1문의<span class="icon-membersonly2">회원전용</span></a></li>
	...
	<div class="layout-inner">
		<section class="qna-wrap">
			...
			<div class="list-basic">
				...
				<div class="list-item">
					<em class="col category">한경닷컴 웹페이지-회원 관련</em>
					<div class="col tit">
						<a href="https://www.hankyung.com/help/qna/view?no=271" class="qna-tit">문의드립니다.</a>
					</div>
					<div class="col qna-info">
						<span class="col date txt-num">2023.09.12</span>
						<div class="col state"><span class="badge-answer ">답변대기</span></div>
					</div>
				</div>
			</div>
