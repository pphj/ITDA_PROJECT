...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/info/requests.css">
...
<body>
	...
	<div class="board_write_wrap">
		<div class="board_group">
			<form action="contentadd.co" method="post"
				...
				<div class="board_tag_wrap">
					<input class="board_tag_text" type=text id="input_tag"
						placeholder="태그를 추가해 보세요(최대 5개)">
					<button class="tag_add" id="tag_add" type="button"
						onclick="cnt_tag();">추가</button>
					...
					<div class="thumbNailArea">
						...
						<div style="height: 50px; margin: 15px 20px 0px 0px">
							<label class="thumbNailUploadArea" for="file"> <img
								src="../image/content/thumbnailupload.png"
								style="width: 100px; height: 100px;"><br> <span
								style="color: #c9c9c9">썸네일 업로드</span> <input
								class="thumbNailUpload" type="file" name="thumbNail" id="file"
								accept="image/*">
							</label>
						</div>
