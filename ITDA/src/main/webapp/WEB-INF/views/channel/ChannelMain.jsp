...
<body>
	...
	<div class="wrap_profile">
		<div class="bloger_thumb">
			<img class="profileUserImage img_thumb"
				...
				width="100" height="100" alt="이미지정보"> <input
				class="profileUserImageUrl" type="hidden"
			...
			<input type="hidden" name="myWriter" value="false"> <span
				...
				<button type="button"
					...
					<span class="txt_default"><img class="ico_plus"
						src="../image/channel/ico-plus.png" alt="알림 버튼 아이콘">알림</span>
				</button>
				<button type="button"
					class="btn_type btn_new_type btn_default btn_profile btnFollow #p_follow">
					<span class="txt_default"><img class="ico_plus"
						src="../image/channel/ico-plus.png" alt="구독 버튼 아이콘">구독</span>
				</button>
			</span>

		</div>
	</div><!-- <div class="wrap_profile"> 채널바 -->
	...
	<div class="tab_contents">
		...
		<ul id="contentsTab" class="list_tab">
		    <li><a href="javascript:void(0);" class="infoTab link_tab #info_open" onclick="onTabClick('info')"> 
		    		<span class="txt_tab">채널소개</span>
		    	</a>
		    </li>
		    <li class="on"><a href="javascript:void(0);" class="articleTab link_tab" onclick="onTabClick('articles')"> 
		    		<span class="txt_tab">게시글</span>
		    	</a>
		    </li>
		    <li><a href="javascript:void(0);" class="magazineTab link_tab" onclick="onTabClick('works')"> 
		...
		<div class="wrap_contents">
							...
							<c:forEach var="c" items="${channeldetail}">
								<ul class="list_article list_post1 #post_list">
									<li data-articleuid="xTI_303" class="animation_up"
										...
										href="/magazine/whatwetalkabout" class="link_category"> <em
											class="tit_category">${c.chCate_Name}</em>
									</a> <a
										href="${pageContext.request.contextPath}/contents/${channel.chNum}/${c.boardNum}"
							     ...
							     -->
												...
												<span class="ico_dot"></span> <span class="publish_time">8시간전</span>
										</span>
									</a></li>
			...
			<div class="tab_content" id="info">
				<div class="author_intro animation_up">
					...
					<p class="desc_intro">마음속에 담아둔 말이 많은 내과 의사. 마흔을 앞둔 지금, 의학
						'드라마'가 아닌 진짜 이야기를 쓰고 싶습니다.</p>
					<ul class="list_tag">
						<li><a href="/keyword/profile/에세이"
							class="link_tag #profilekeyword">에세이</a></li>
						<li><a href="/keyword/profile/가족"
							class="link_tag #profilekeyword">가족</a></li>
						<li><a href="/keyword/profile/육아"
							class="link_tag #profilekeyword">육아</a></li>
						<li><a href="/keyword/profile/의사"
							class="link_tag #profilekeyword">의사</a></li>
						<li><a href="/keyword/profile/출간작가"
							class="link_tag #profilekeyword">출간작가</a></li>
						<li><a href="/keyword/profile/교수"
							class="link_tag #profilekeyword">교수</a></li>
					</ul>
										...
										<div class="channel_stats_both">
											<div class="channel_stats_left">
												<ul class="channel_stats_graph">
													...
													<li class="channel_stats_item">
														...
														</div> <!-- <div class="channel_stats_legend">10<span class="channel_stats_legend_unit">대</span></div> -->
													</li>

													<li class="channel_stats_item">
														<div class="channel_stats_bar">
															<div class="channel_stats_bar_value is_2"
																style="height: 64%;">
																<span class="channel_stats_bar_percent">24%</span> <span
																	class="channel_stats_bar_text">2<span
																	class="blind">위</span></span>
															</div>
														</div>
													</li>
													...
													<li class="channel_stats_item">
														<div class="channel_stats_bar">
															<div class="channel_stats_bar_value is_1"
																style="height: 100%;">
																<span class="channel_stats_bar_percent">38%</span> <span
																	class="channel_stats_bar_text">1<span
																	class="blind">위</span></span>
															</div>
														</div>
													</li>
											...
											<div class="channel_stats_right">
												<div class="channel_stats_donut">
													<div id="_CHANNEL_HOME_PROFILE_SUBSCRIBER_GENDER"
														class="pie_chart _gender_chart bb"
														...
														<g
																class="bb-shapes bb-shapes-female bb-arcs bb-arcs-female">
														<path class="bb-shape bb-shape bb-arc bb-arc-female"
																transform="scale(1,1)" style="fill: rgb(232, 147, 147);"
														...
														<text dy=".35em"
																transform="translate(-11.141215697917236,-15.636921460840131)"
														...
														<path class="bb-shape bb-shape bb-arc bb-arc-male"
																transform="scale(1,1)" style="fill: rgb(102, 135, 187);"
														...
														<text dy=".35em"
																transform="translate(11.141215697917218,15.63692146084014)"
													...
													<div class="channel_stats_donutlegend">
														<span
															class="channel_stats_donutlegend_item _GENDER is_female"
															data-id="female" data-percent="0.1921540991308433">여자</span>
														<span
															class="channel_stats_donutlegend_item _GENDER is_male"
															data-id="male" data-percent="0.8078459008691566">남자</span>
													</div>
												</div>
											</div>
										</div>
				...
				</div><!-- 	<div class="author_intro animation_up"> 통계 -->
			</div><!-- <div class="tab_content" -->
