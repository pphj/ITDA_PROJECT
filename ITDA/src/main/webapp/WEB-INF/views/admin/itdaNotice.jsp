    	...
    	<div class="card">
			<div class="card-body">
	 		...
	 		<tbody>
	 			...
	 			<c:forEach var="F" items="${itdaNoticeList}">
	 				<tr>
	 					...
	 					<td class="text-center">		<%-- 제목 부분 --%>
	 						<div>
	 							<a href="${pageContext.request.contextPath}/admin/itdaNotice/${F.adNum}">
		 	...
		 	<div class="center-block">
		 		<ul class="pagination justify-content-center">
		 			...
		 			<c:if test="${page > 1}">
		 				<li class="page-item">
		 					<a class="page-link" href="itdaNotice?page=${page-1}"><i class="fa fa-chevron-left" aria-hidden="true"></i>;</a>
		 				</li>
		 			</c:if>
		 			...
		 			<c:forEach var="a" begin="${startpage}" end="${endpage}">
		 				...
		 				<c:if test="${a != page}">
		 					<li class="page-item">
		 						<a class="page-link" href="itdaNotice?page=${a}">${a}</a>
		 					</li>
		 				</c:if>
		 			</c:forEach>
		 			...
		 			<c:if test="${page < maxpage}">
		 				<li class="page-item">
		 					<a class="page-link" href="itdaNotice?page=${page+1}"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
		 				</li>
		 			</c:if>
		 		</ul>
		 	</div>
