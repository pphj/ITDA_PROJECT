			...
			<div class="content_group">
				<div class="head_content">
					<div class="head_service">
						<div class="head_back">
							<a class=back_content href="chnnals/${param.chnum}"> <img src="../image/content/errow_left.png" width="20"></a>
						</div>
					</div>
				...
				<div class="content_line">
					<div class="content_tap_wrap">
						<h3 class="content_head">
							<span class="content_cate_title" style="color: #666666">
								<c:out value="${param.chcate_name}" default='전체글' />
							</span>
							<em>${listcount}</em>
						</h3>
					</div>
		...
		<div class="content_group_wrap">
			<div class="content_group">
				<div class="head_content">
					<div class="head_service">
						<div class="head_back">
							<a class=back_content href="../channels/${param.chnum}"><img src="../image/content/errow_left.png" width="20"></a>
						</div>
					</div>
					<h2 class="head_title">${param.chname}</h2>
				</div>
									...
									<div class="content_text">
										...
										<div class="content_info" style="color: #666666">
											<span class="content_comment_wrap">
												...
												<a><img class="content_comment_img" src="../image/content/heart.png"> <span class="content_comment_count">${b.boardHeart}</span></a>
												<a><img class="content_comment_img" src="../image/content/comment.png"> <span class="content_comment_count">${b.cnt}</span>
												</a>
											</span>
										</div>
									</div>
