...
<body>
	...
	<input type="hidden" id="chnum" value="" name="chnum">
	<input type="hidden" id="boardnum" value="" name="boardnum">
<body>
	<div class="pop_wrap">
			...
			<div class="pop_content">
				<div class="lst_report">
					<dl class="report_area">
						...
						<dd class="report_nick">yoda****</dd>
						<dt>
							<span class="inner">내 용</span>
						</dt>
						<dd class="report_cont">산업도 완전히 바뀌고 금융 정책도 바뀌고 재정 상황도 바뀌고 투자자들의 구성이나 성향이나 정보의 수준에 따른 대응도 완전히 바뀌었는데. 36년 전을 가지고 현재를
							예측한다는 것은 씨잘데기 없는 코메디일 뿐임.</dd>
					</dl>
				</div>
					...
					<div class="list_type">
						<ul>
							...
							<li class="list">
								...
								<div class="check_area">
									<label for="6">불쾌한 표현이 있습니다.</label>
									<button type="button" class="more">
										<span class="blind">더보기</span>
									</button>
									<ul class="answer_area">
										<li class="list_answer">불쾌한 표현 포함 (해당 사유는 클린봇 학습에 도움이 될 수 있습니다.)</li>
									</ul>
								</div>
							</li>
						</ul>
