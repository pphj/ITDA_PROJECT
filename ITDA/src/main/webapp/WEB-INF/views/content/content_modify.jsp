...
<body>
	...
	<div class="board_write_wrap">
		<div class="board_group">
			<form action="${pageContext.request.contextPath}/contents/${chnum}/contentmodify" method="post" enctype="multipart/form-data">
				<input type="hidden" name="chNum" id="chNum" value="${chnum}"> <input type="hidden" name="boardNum" id="boardNum"
					value="${chboard.boardNum}">
				...
				<div class="board_subject_wrap">
					<input class="text_from board_subject_from" type=text name="boardTitle" value="${chboard.boardTitle}">
				</div>
				<div class="board_content_wrap">
					<div class="editor_group">
						<textarea name="boardContent" id="editor">${chboard.boardContent}</textarea>
				...
				<div class="board_button_wrap">
					<button type="button" class="board_write_button write_cancel">수정취소</button>
					<button type="submit" class="board_write_button">수정완료</button>
				</div>
