...
function showMenu(subMenu) {
	...
	<div id="content">
		...
		<div class="section_delete">
			...
			<td>이용내역, 보유 중인 할인 쿠폰 등 관련된 모든 정보 삭제, 네이버페이 포인트/네이버페이 머니 소멸 및 약관 동의 철회</td>
			</tr>

			<th scope="row">네이버 프리미엄 콘텐츠</th>
			<td>구독, 구매 내역 및 이용 이력 전체 삭제</td>
			</tr>
			<th scope="row">네이버 프리미엄 콘텐츠 스튜디오</th>
			...
			<tr>
				...
				<td>구독 채널, 구매/대여한 오디오북, 쿠폰, 최근 들은 클립, 북마크 내역 삭제</td>
			</tr>
			<tr>
			<th scope="row">이용권</th>
			...
			<tr>
				<th scope="row">클로바더빙</th>
				<td>생성된 프로젝트, 보이스 메이커 제작 현황 및 제작된 AI 보이스 삭제</td>
			</tr>
			<tr>
				<th scope="row">네이버 비즈니스 스쿨</th>
				<td>네이버 비즈니스 스쿨 교육 포인트 소멸 및 내역 삭제</td>
			</tr>
			<tr>
				<th scope="row">네이버 QR코드</th>
				<td>저장된 모든 QR코드 삭제</td>
			</tr>
			...
			<tr>
			<th scope="row">네이버TV</th>
			<td>
                                업로드한 영상, 댓글, 영상에 대한 &#39;좋아요&#39; 등
                            </td>
			</tr>
			...
			<tr>
				<th scope="row">쇼핑라이브</th>
				<td>라이브, 댓글, 채팅, 하이라이트, 좋아요 등</td>
			</tr>
			<tr>
				<th scope="row">오디오클립</th>
				<td>댓글 및 좋아요</td>
			...
			<tr>
				<th scope="row">인플루언서 검색</th>
				<td>인플루언서 홈의 댓글 및 좋아요</td>
			</tr>
			<tr>
				<th scope="row">오픈톡</th>
				<td>채팅방 내 채팅 메시지 및 리액션</td>
			</tr>

			<tr>
				<th scope="row">네이버 영화</th>
				<td>영화 평점, 영화 리뷰, 리뷰 추천, 댓글 및 좋아요 등</td>
			</tr>
			<tr>
				<th scope="row">네이버 쇼핑</th>
				<td>문의, 리뷰, 댓글 등</td>
			</tr>
			<tr>
				<th scope="row">오픈사전PRO</th>
				<td>표제어, 사전, 댓글, 좋아요 및 즐겨찾기 등</td>
			</tr>
			<tr>
			<th scope="row">기타</th>
           ...
           <div class="more_wrap"> 
			...
			<form name="fm" id ="fm" method="post" action="/user2/help/leaveId?m=viewInputUserInfo">
				<input type="hidden" name="token_help" value="" />
				<input type="hidden" name="lang" value="ko_KR" />
				<div class="dropout_agree_area">
					<p class="contxt">
						<strong>
						     	  탈퇴 후에는 아이디 <em>vldzmskcy</em> 로 다시 가입할 수 없으며 아이디와 데이터는 복구할 수 없습니다.
						     <br>
