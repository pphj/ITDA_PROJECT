...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/resources/**/**").permitAll().antMatchers("/**/**").permitAll()
				.antMatchers("/joinProcess").permitAll().antMatchers("/seller/sellerCheck").permitAll()
		...
		http.formLogin().loginPage("/main/protomain").loginProcessingUrl("/member/loginProcess")
				.usernameParameter("userId").passwordParameter("userPw").successHandler(loginSuccessHandler())
