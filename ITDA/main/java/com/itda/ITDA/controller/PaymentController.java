	...
	public String kakaopay() {
		try {
			...
			String parameter = "cid=TC0ONETIME" // 가맹점 코드
					...
					+ "&approval_url=http://localhost:9400/my/subscriptions" // 결제 성공 시
					+ "&fail_url=http://localhost:9400/itda/product/subscriptions/info/order" // 결제 실패 시
					+ "&cancel_url=http://localhost:9400/itda/product/subscriptions/info/order"; // 결제 취소 시
